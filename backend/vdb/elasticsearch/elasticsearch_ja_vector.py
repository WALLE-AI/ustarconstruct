...
from backend.vdb.elasticsearch.elasticsearch_vector import ElasticSearchConfig, ElasticSearchVector, ElasticSearchVectorFactory
...
class ElasticSearchJaVectorFactory(ElasticSearchVectorFactory):
    def init_vector(self, collection_name:str,embeddings: Embeddings) -> ElasticSearchJaVector:
