...
from backend.vdb.field import Field
...
class ElasticSearchVectorFactory(AbstractVectorFactory):
    def init_vector(self, collection_name:str, embeddings: Embeddings) -> ElasticSearchVector:
        ...
        use_cloud_env = os.getenv("ELASTICSEARCH_USE_CLOUD", False)
        ...
        config_dict.update(
            {
                ...
                "verify_certs": bool(os.getenv("ELASTICSEARCH_VERIFY_CERTS", False)),
                "request_timeout": int(os.getenv("ELASTICSEARCH_REQUEST_TIMEOUT", 100000)),
                "retry_on_timeout": bool(os.getenv("ELASTICSEARCH_RETRY_ON_TIMEOUT", True)),
